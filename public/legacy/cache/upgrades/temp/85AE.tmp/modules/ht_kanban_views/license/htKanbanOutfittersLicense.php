...
if(!class_exists('htKanbanOutfittersLicense')) 
{
    class htKanbanOutfittersLicense
    {
        /**
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false)
        {
            ...
            $validated = htKanbanOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = htKanbanOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
            ...
            echo $json->encode($validated['result']);die;
        }
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('htKanbanOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('htKanbanOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = htKanbanOutfittersLicense::doValidate($currentModule);
