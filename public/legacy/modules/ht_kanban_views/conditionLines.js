...
function showModuleField(ln, operator_value, type_value, field_value) {
    ...
    if (aow_field != '') {
        ...
        YAHOO.util.Connect.asyncRequest("GET", "index.php?module=ht_kanban_views&action=getFieldTypeOptions&view=" + action_sugar_grp1 + "&aow_module=" + flow_module + "&aow_fieldname=" + aow_field + "&aow_newfieldname=" + aow_field_type_name + "&aow_value=" + type_value + "&rel_field=" + rel_field, callback2);
